...
public class helicopterManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
        playerTransform = PlayerController.getPlayerTransform();
        targetPosition = playerTransform.position + playerTransform.forward * 20f + Vector3.up * 5f;
        if (!reachedTarget)
        {
        ...
        else
        {
            ...
            Vector3 followPosition = playerTransform.position + playerTransform.forward * 20f + Vector3.up * 5f;
